...
function createPreset(tree, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        else if (options.preset === presets_1.Preset.NPM) {
            return;
        }
        else if (options.preset === presets_1.Preset.Angular) {
            const { applicationGenerator: angularApplicationGenerator, } = require('@nrwl' + '/angular/src/generators/application/application');
        ...
        else if (options.preset === presets_1.Preset.Gatsby) {
            const { applicationGenerator: gatsbyApplicationGenerator, } = require('@nrwl' + '/gatsby');
            yield gatsbyApplicationGenerator(tree, {
                name: options.name,
                linter: options.linter,
                style: options.style,
                standaloneConfig: options.standaloneConfig,
